  ...
  return (
    <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-xl p-8 my-8">
      ...
      <ul className="list-disc pl-6 space-y-2 mb-4 text-gray-700">
        <li>
          <strong>Responsable:</strong> "Maderistas" – contacto: contacto@maderistas.com
        </li>
        <li>
        ...
        <li>
          <strong>Derechos ARCO:</strong> escribe a contacto@maderistas.com con el asunto "Privacidad".
        </li>
        <li>
